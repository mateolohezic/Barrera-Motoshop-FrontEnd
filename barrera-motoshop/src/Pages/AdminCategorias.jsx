        ...
        <div className="caja__admin mx-auto row">
            <div className='col-4 p-0'>
                <div className='d-flex flex-column'>
                    ...
                    <a href='/Admin/Categorias' className='text-decoration-none text-white active'><div className='titulo__seccion__admin'>Categorías</div></a>
                    <a href='/Admin/Usuarios' className='text-decoration-none text-white'><div className='titulo__seccion__admin'>Usuarios</div></a>
